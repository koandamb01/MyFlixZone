...
public class JavaProjectApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// "saltyhomie", "admin"));
		//
		// Address shipping1 = shippingRepo.save(new Address("1234 bullet street", "San
		// Francisco" ,"California", "11111", user1));
		// Address shipping2 = shippingRepo.save(new Address("4314 boom street", "New
		// York" ,"New York", "22222", user4));
		...
		//
		// Product product1 = productRepo.save(new Product("Chocolate", 5.55, 13, "Great
		// tasting chocolate. It is one of the best.", user6));
		// Product product2 = productRepo.save(new Product("Stick", 111.55, 122, "Great
		// tasting Stick. It is one of the best.", user4));
		// Product product3 = productRepo.save(new Product("Pencil", 222.42, 22, "Great
		// tasting Pencil. It is one of the best.", user3));
		// Product product4 = productRepo.save(new Product("Phone", 33.11, 5, "Great
		// tasting Phone. It is one of the best.", user5));
		//
